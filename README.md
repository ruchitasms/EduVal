...
- The Learning Hub: A built-in, collapsible glossary that explains the practical "Real-World" application of metrics like Net Debt/EBITDA.

### ⛏️ Built With
- API: Financial Modeling Prep (FMP) Stable API.
- Frontend: HTML5, CSS (Pico.css Framework), JavaScript.
- Visualization: Chart.js for real-time market momentum tracking.

 ### 🏢 Constraints
 Since this project uses a free api, we're kepping our study narrowed down to 10 publicly traded companies across different sectors.
